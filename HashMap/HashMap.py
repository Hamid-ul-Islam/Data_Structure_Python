#hashmap node : simply a list where every block contains a LinkedList. when we try to insert a key value pair into the list we module  HashCod(key) % size of the buckets/list and we find a specific index. we t
class MapNode:
