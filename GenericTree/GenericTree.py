...
#take generic tree input (for every input func we have to take input first and create a node. then we have to take care of the base case  link nodes with each)
def takeInput():
